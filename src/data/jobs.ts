...
export const JOBS: Job[] = [
  ...
  },
  {
    ...
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487056162803101696',
    status: 'open',
    summary:
      'Developing and optimising infrastructure, automating processes and improving reliability, monitoring and scalability. The post describes the person wanted rather than a hard requirement list.',
    stack: [
      'Infrastructure development & optimisation', 'Process automation',
      'Monitoring & logging', 'Performance & scalability',
    ],
    applyUrl: 'https://lnkd.in/eqH-53pb',
  },
  {
    slug: 'payampardaz-multi-role',
    title: 'Python Developer · Golang Developer · Sales Specialist',
    company: 'PayamPardaz',
    category: 'Engineering',
    location: 'Isfahan',
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487055100796989440',
    status: 'open',
    summary:
      'Three openings in Isfahan across a cybersecurity and network-security context — a Python developer, a Golang developer and a sales specialist. The post names the roles and their area but lists no per-role requirements.',
    stack: ['Python', 'Golang', 'SOC / security operations', 'Network security', 'QA'],
    applyNote:
      'One post covering three separate roles; say which you mean. The post names no email, form or link — expect to message the poster.',
  },
  {
  ...
  {
    slug: 'fmcg-confectionery-product-manager',
    title: 'Product Manager (FMCG / confectionery)',
    company: 'Not named in the post',
    category: 'Product',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487021086333812736',
    status: 'open',
    summary:
      'Owning product strategy in the FMCG confectionery sector — market and competitor analysis, new-product development and lifecycle management, working across advertising, sales, R&D and supply chain. At least three years as a product manager in FMCG is required.',
    stack: [
      '3+ years as an FMCG product manager', 'Market & competitor analysis',
      'Sales data analysis', 'New product development (NPD)', 'Product lifecycle management',
      'Cake & confectionery experience (preferred)', "Master's in management (preferred)",
    ],
    contact: 'Moghadasi@mazmaz.net',
    applyNote:
      'The employer is not named. The post also states a preferred age range of 30–40 — worth knowing before you apply.',
  },
  {
    slug: 'golang-swe-ai-tools',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487078716926324736',
    status: 'open',
    summary:
      'A Golang role framed around engineering judgment over raw coding speed — clean code, design, and analysing problems from the business side. The post explicitly values AI-assisted development and building agent skills.',
    stack: [
      'Golang', 'Clean Code', 'Design patterns & software engineering',
      'Business-level problem analysis', 'AI tools & agent-skill development',
    ],
    applyNote: 'The employer is not named and the post gives no email or link — expect to message the poster.',
  },
  {
    slug: 'graph-inc-threat-hunter',
    title: 'Threat Hunter',
    company: 'GRAPH Inc.',
    category: 'Security',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487046299821830144',
    status: 'open',
    summary:
      'A threat-hunting position on a security team. The post itself carries no requirements — the full description sits behind the linked page.',
    stack: [],
    contact: 'hr@graph-inc.ir',
    applyUrl: 'https://jobinja.ir/1492520',
  },
  {
    slug: 'nobitex-senior-frontend',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487115418852179968',
    status: 'open',
    summary:
      'Building reliable, smooth interfaces for a cryptocurrency exchange used by millions, handling real-time data and sensitive financial decisions. The post is a pitch — concrete requirements are behind the link.',
    stack: [],
    applyUrl: 'https://lnkd.in/ec749Hi4',
  },
  {
    slug: 'shopino-senior-product-manager',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487106289454620672',
    status: 'open',
    summary:
      'Defining product strategy and roadmap for a lifestyle e-commerce platform, working across functions and making data-driven calls on customer experience and growth. At least five years of professional experience is required.',
    stack: [
      '5+ years professional experience', 'Marketplace or e-commerce',
      'SQL, dashboards, funnel & cohort analysis', 'A/B testing',
      'AI & automation', 'Analytical, problem-solving mindset',
    ],
    contact: 'hr@shopino.app',
    applyUrl: 'https://lnkd.in/eM6Cjn4v',
  },
  {
  ...
  {
    slug: 'amanafzar-linux-system-engineer',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-26',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487014022660308992',
    status: 'open',
    summary:
      'Infrastructure work for someone who enjoys optimisation and solving operational problems — system stability, security automation and monitoring inside a collaborative, agile team.',
    stack: [
      'Linux', 'Bash scripting', 'Python', 'Networking & security', 'Monitoring',
      'Virtualization', 'Ansible', 'CI/CD', 'Infrastructure',
    ],
    applyUrl: 'https://B2n.ir/wz9736',
  },

  // ---------- 2026-07-25 ----------
  {
    slug: 'fasatech-senior-backend-dotnet',
    title: 'Senior Backend Software Engineer (.NET)',
    company: 'FASA (Saipa Technology Communication)',
    category: 'Engineering',
    location: 'Tehran, km 15 Karaj Road (Saipa)',
    arrangement: 'On-site',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486644072489582592',
    status: 'open',
    summary:
      'Designing, building and maintaining scalable backend services and APIs on .NET — business logic, database optimisation, and working with the frontend and DevOps teams.',
    stack: [
      'C# / .NET, ASP.NET Core', 'RESTful API design', 'Entity Framework Core',
      'SQL Server / PostgreSQL', 'OOP, SOLID, design patterns', 'JWT, OAuth2',
      'gRPC', 'Git', 'Docker (preferred)', 'Microservices (preferred)',
      'Async & multithreading',
    ],
    contact: 'b.akbari@fasatech.ir',
    applyNote: 'On-site, Sat–Wed 07:30–16:30 with an hour of flex time.',
  },
  {
    slug: 'sepid-system-backend-dotnet',
    title: 'Back-End Developer (C# / .NET Core)',
    company: 'Sepid System',
    category: 'Engineering',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486714794646085632',
    status: 'open',
    summary:
      'Two back-end developers to design and maintain scalable systems on .NET Core. At least four years of .NET Core web development is required; access-control and face-recognition experience is a plus.',
    stack: [
      '4+ years with .NET Core', 'C#', '.NET 8 / ASP.NET Core', 'Entity Framework Core',
      'Microservices', 'Design patterns & Clean Architecture', 'RabbitMQ',
      'SOLID', 'Git / GitLab / GitHub',
      'Access control & face recognition (advantage)', 'Docker (advantage)',
    ],
    contact: 'cto@sepidsystem.com',
  },
  {
    slug: 'snapptrip-senior-frontend',
    title: 'Senior Front-End Developer',
    company: 'SnappTrip',
    category: 'Engineering',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486715376261562368',
    status: 'open',
    summary:
      'Building and maintaining modern interfaces on React and Next.js (App Router) for a travel platform, working inside an NX monorepo across teams.',
    stack: [
      'JavaScript (ES6+) & TypeScript', 'React.js', 'Next.js App Router',
      'SSR / SSG / ISR / Server Components', 'NX & monorepos',
      'Atomic Design / design systems', 'TailwindCSS',
      'Lighthouse & Core Web Vitals', 'Jest / Playwright', 'CI/CD',
    ],
    applyUrl: 'https://lnkd.in/dG6mQ7aR',
  },
  {
    slug: 'unnamed-senior-frontend-nuxt-vanak',
    title: 'Senior Front-End Developer (Nuxt / Vue)',
    company: 'Not named in the post',
    category: 'Engineering',
    location: 'Tehran, Vanak Square',
    arrangement: 'On-site, full-time',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486668594509127680',
    status: 'open',
    summary:
      'A senior front-end position built around Nuxt.js and Vue.js, on-site in Tehran. The post gives the stack and location but not the employer.',
    stack: ['Nuxt.js', 'Vue.js'],
    applyUrl: 'https://jobinja.ir/1493652',
    applyNote: 'The employer is not named in the post.',
  },
  {
    slug: 'haji-freelance-uiux-designer',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486835292729933824',
    status: 'open',
    summary:
      'A UI/UX designer who treats experience and product quality as more than the interface, working with the product team on digital design. About two years of experience is expected.',
    stack: [
      '~2 years experience', 'Figma', 'UI/UX principles', 'Design systems',
      'Strong portfolio', 'EdTech & Gen-Z sensibilities (preferred)',
    ],
    contact: 'melikaansari9@gmail.com',
  },
  {
    slug: 'talaland-senior-dotnet',
    title: 'Senior .NET Developer',
    company: 'Talaland',
    category: 'Engineering',
    location: 'Tehran, Gandhi',
    arrangement: 'On-site, full-time',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486773826735824897',
    status: 'open',
    summary:
      'A senior .NET position at Talaland, on-site in the Gandhi area of Tehran. The post is a short hiring call and points at the application page for detail.',
    stack: ['.NET'],
    applyUrl: 'https://lnkd.in/en24ZTkv',
  },
  {
    slug: 'ali-liaghat-website-designer',
    title: 'Website Designer (project-based)',
    company: 'Not named in the post',
    category: 'Design',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486797992432353280',
    status: 'open',
    summary:
      'A freelance website designer with a strong portfolio and UI/UX experience, wanted for a specific project.',
    stack: ['Web design', 'UI/UX', 'Strong portfolio'],
    applyNote: 'Project-based freelance work — the post asks you to message the poster (Ali Liaghat) with a resume or portfolio.',
  },
  {
    slug: 'mohimn-devops-sre',
    ...
    arrangement: 'On-site, full-time',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486801273573433345',
    status: 'open',
    summary:
      'Keeping critical services stable and available — reading logs to find infrastructure issues and building the fixes — including work on national-scale projects. At least two years in DevOps, SRE, operations or technical support is required.',
    stack: [
      '2+ years in DevOps / SRE / ops', 'Linux & service troubleshooting',
      'Log analysis & root-cause analysis', 'CI/CD', 'Docker & Docker Swarm',
      'Kubernetes (basic)', 'SQL & NoSQL', 'Monitoring & alerting',
    ],
    applyNote: 'The post asks you to message the poster (Mohammad Hosein Heydarzadeh) on LinkedIn with a resume.',
  },
  {
    slug: 'unnamed-fintech-backend-php',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486728368936337409',
    status: 'open',
    summary:
      'Designing and maintaining scalable microservices for a fintech handling high-volume financial transactions. The employer is not named in the post.',
    stack: [
      'PHP & OOP', 'Laravel', 'Microservices', 'RESTful APIs', 'Message brokers',
      'Git', 'Docker', 'Linux', 'Nginx', 'Database design & optimisation',
      'Fintech / distributed systems (preferred)', 'CI/CD (preferred)',
    ],
    contact: 'a.r.zarezade@gmail.com',
    applyNote: 'The employer is not named; applications go to a personal Gmail address.',
  },
  {
    slug: 'financial-group-five-tech-roles',
    title: 'System Administrator · Technical Support · Infrastructure Manager · DevOps Engineer · Senior .NET Developer',
    company: 'Not named in the post',
    category: 'Engineering',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486759667054919680',
    status: 'open',
    summary:
      'A financial group hiring across five technical roles at once as it expands. The post names the roles and links each one, without listing requirements.',
    stack: [],
    applyNote:
      'One post covering five roles; each has its own cdoo.ir application link. The company is not named in the post.',
  },
  {
    slug: 'unnamed-product-designer-mirdamad',
    title: 'Product Designer',
    company: 'Not named in the post',
    category: 'Design',
    location: 'Tehran, Mirdamad',
    arrangement: 'On-site, full-time',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486667036773920768',
    status: 'open',
    summary:
      'Shaping a new product from its early stages — user flows, wireframes, prototypes and final UI — working with product and development to keep experiences simple and cohesive. Healthcare-domain familiarity is a plus.',
    stack: [
      'Digital product / web / app design', 'UX/UI principles', 'Figma',
      'User flows, wireframes, prototypes', 'User research & usability testing',
      'Design systems', 'Healthcare domain (a plus)',
    ],
    contact: 'majid.taghadosi@gmail.com',
    applyNote: 'The employer is not named in the post.',
  },
  {
    slug: 'hamrah-jeeb-product-owner',
    title: 'Product Owner',
    company: 'Hamrah Jeeb',
    category: 'Product',
    location: 'Not specified',
    arrangement: 'On-site',
    posted: '2026-07-25',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486789155436519424',
    status: 'open',
    summary:
      'A product owner to lead fintech, credit and corporate-banking initiatives. The post asks for real experience with financial and banking products.',
    stack: [
      'Fintech, credit products & corporate banking experience',
      'Familiarity with financial & banking products', 'Product management',
    ],
    applyUrl: 'https://lnkd.in/dPXPX3iC',
  },

  // ---------- 2026-07-24 ----------
  {
    slug: 'ecoholding-backend-laravel',
    title: 'Backend Developer (Laravel)',
    company: 'EcoHolding',
    category: 'Engineering',
    location: 'Tehran, Dolat Street',
    arrangement: 'On-site, full-time',
    posted: '2026-07-24',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7486435061110640640',
    status: 'open',
    summary:
      'Building and maintaining robust APIs and MySQL databases on PHP/Laravel, with an eye on security, concurrency and scalability. At least two years of professional Laravel experience is required.',
    stack: [
      '2+ years PHP / Laravel', 'RESTful APIs', 'SOLID', 'MySQL design',
      'Redis / RabbitMQ queues', 'Caching', 'Git', 'Web security',
      'Concurrency & ACID transactions', 'Docker, CI/CD, fintech (nice to have)',
    ],
    contact: 'mahsamorady@yahoo.com',
    applyNote: 'Use an email subject in the form "رزومه [Your Name]".',
  },
  {
    slug: 'azkivam-tech-team-roles',
    title: 'Engineering — technical team roles',
    company: 'Azkivam',
    category: 'Engineering',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-24',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7487034827322474497',
    status: 'open',
    summary:
      "Azkivam's technical team is expanding and looking for skilled engineers. The post is an open invitation — it names no specific title, requirements or conditions.",
    stack: [],
    applyUrl: 'https://lnkd.in/eMdzQ6jk',
    applyNote: 'The post gives no specific role title or requirements — everything is behind the link.',
  },

  // ---------- 2026-07-22 (batch continued) ----------
  {
    slug: 'printing-sohrabi-laravel-architect',
    title: 'Laravel Developer / Software Architect',
    company: 'Printing Sohrabi',
    category: 'Engineering',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-22',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7485580440704200704',
    status: 'open',
    summary:
      'Designing and building a comprehensive print-management platform — online ordering, CRM, financial, inventory, production and accounting, delivered as SaaS. Written as a call for a Laravel developer or architect to shape the system.',
    stack: [
      'Laravel', 'Enterprise systems architecture', 'SaaS platform development',
    ],
    applyNote: 'The post asks you to message the poster (Parisa Sohrabi) with portfolio samples, a resume and your collaboration terms.',
  },
  {
    slug: 'kanoon-iran-novin-ai-artist',
    title: 'AI Artist',
    company: 'Kanoon Iran Novin',
    category: 'Media & Creative',
    location: 'Not specified',
    arrangement: 'Not specified',
    posted: '2026-07-22',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7485698728897445888',
    status: 'open',
    summary:
      'Combining human creativity with AI tools to turn ideas into images, video and brand experiences, working with the creative and digital teams on campaigns.',
    stack: [
      'AI visual content creation', 'Concept design',
      'Digital image & video creation', 'AI tool proficiency',
    ],
    applyUrl: 'https://lnkd.in/gGg2vrH4',
  },
  {
    slug: 'unnamed-graphic-designer-tehran',
    title: 'Graphic Designer',
    company: 'Not named in the post',
    category: 'Media & Creative',
    location: 'Tehran, Jomhouri',
    arrangement: 'Not specified',
    posted: '2026-07-22',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7485597172940341248',
    status: 'open',
    summary:
      'An electronics-components company is hiring a graphic designer for its Tehran office. The post gives little beyond the location and asks for a resume and samples.',
    stack: [],
    contact: 'soroushkoushan@gmail.com',
    applyNote: 'The employer is described only as an electronics-components company, not named.',
  },

  // ---------- 2026-07-21 (batch continued) ----------
  {
    slug: 'unnamed-uiux-cofounder-equity',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-21',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7485315145246638080',
    status: 'open',
    summary:
      'A founding UI/UX designer to build a new startup product from scratch. The post is explicit that there is no salary for now — this is an equity / co-founder arrangement.',
    stack: ['UI/UX design', 'Digital product design', 'Figma'],
    unpaid: true,
    applyNote:
      'Co-founder / equity role — the post states there is no salary at present. Applications go by LinkedIn DM to the poster (M. Matin Parvizi).',
  },

  // ---------- 2026-07-20 (batch continued) ----------
  {
    slug: 'nobitex-senior-software-engineer-0720',
    ...
    arrangement: 'Not specified',
    posted: '2026-07-20',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7484933885911363584',
    status: 'open',
    summary:
      'A senior software engineer opening at the cryptocurrency exchange Nobitex. The post is a short hiring call and points at the application link for detail.',
    stack: [],
    applyUrl: 'https://lnkd.in/eHFhS-gF',
    applyNote: 'Nobitex advertised a senior software engineer role again on 2026-07-22 with a different application link — they may be the same opening.',
  },

  // ---------- 2026-07-15 (batch continued) ----------
  {
    slug: 'unnamed-python-automation-tehran',
    ...
    arrangement: 'On-site, full-time',
    posted: '2026-07-15',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7483149226487574528',
    status: 'open',
    summary:
      'Building automation scripts and solving technical problems in Python. On-site and full-time in Tehran.',
    stack: [
      'Python', 'Automation & scripting', 'APIs', 'Problem-solving',
      'Teamwork', 'Git (an advantage)',
    ],
    contact: 'infohr@agri-bank.com',
    applyNote: 'The employer is not named in the post; the application email is on the agri-bank.com domain.',
  },

  // ---------- 2026-07-09 (batch continued) ----------
  {
    slug: 'linkup-senior-frontend-vue',
    ...
    posted: '2026-07-09',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7480945793240207361',
    status: 'open',
    summary:
      'A senior frontend engineer expected to weigh in on architecture and product foundations, not just code, for a Canadian B2B SaaS startup with an international team. At least four years with Vue and TypeScript is required.',
    stack: [
      '4+ years Vue.js & TypeScript', 'Scalable frontend architecture',
      'API-driven SPAs', 'Reusable components', 'State management',
      'Complex forms', 'Performance optimisation',
    ],
    contact: 'zahrajiriaei.iust@gmail.com',
    applyNote: 'Remote, for a Canadian B2B SaaS startup with an international team.',
  },

  // ---------- 2026-06-30 (batch continued) ----------
  {
    slug: 'snapppay-senior-backend-java',
    ...
    arrangement: 'Not specified',
    posted: '2026-06-30',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7477718818262335490',
    status: 'open',
    summary:
      'Building scalable fintech products on the JVM at a buy-now-pay-later company, with an emphasis on problem-solving and product impact.',
    stack: ['Java 11+', 'Spring', 'Microservices', 'Docker', 'Kubernetes'],
    applyUrl: 'https://lnkd.in/e2pia-FV',
  },

  // ---------- 2026-06-28 (batch continued) ----------
  {
    slug: 'digiexpress-product-manager',
    ...
    arrangement: 'Not specified',
    posted: '2026-06-28',
    url: 'https://www.linkedin.com/feed/update/urn:li:activity:7476877529564385281',
    status: 'open',
    summary:
      'Driving new products from idea to launch in the e-commerce / logistics space, working across engineering, QA and design. At least four years in product management is required.',
    stack: [
      '4+ years in product management', 'Data-driven mindset',
      'E-commerce or logistics domain', 'Cross-functional collaboration',
    ],
    applyUrl: 'https://careers.digiexpress.ir',
  },
