...
messages.push(
  [
    ...
    '',
    'فهرست موقعیت‌هایی که این هفته دیدم و به نظرم ارزش معرفی داشتند.',
...
messages.push(
  [
    ...
    '',
    'در چند آگهی نام کارفرما نیامده و رزومه به یک جیمیل یا تلگرام شخصی خواسته شده. پیش از ارسال بپرسید کارفرما کیست.',
    '',
    'یک آگهی علاوه بر حقوق درخواستی، سن، وضعیت تأهل، تعداد فرزند و نشانی منزل را هم خواسته بود. اجباری برای پاسخ دادن ندارید.',
    '',
    'در چند آگهی هیچ ایمیل، فرم یا لینکی برای ارسال رزومه نیامده. متن آگهی را نگه داشته‌ام، اما راه ارسال را خودشان ننوشته‌اند.',
    '',
    collapsed > 0
